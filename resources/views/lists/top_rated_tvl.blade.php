...
<div class="container" style="margin-top:7rem !important;">
    <h1 class="mb-4 text-center text-light">Top Rated Tv Series</h1>
        ...
        @foreach ($series as $tvshow)
                ...
                <div class="col-md-3 mb-4">
                    <div class="text-light">
                        <a href="{{ url('movies/' . $tvshow['id']) }}" class="text-light">
                            ...
                            <div class="card-body text-center">
                                ...
                                <p><i class="bi bi-calendar-event"
                                        style="color:#ffee00;"></i>&nbsp;{{$tvshow['first_air_date']}}
                                </p>
...
<div class="d-flex justify-content-center">
    <nav>
        <ul class="pagination">
            @if ($currentPage > 1)
                <li class="page-item">
                    <a class="page-link" href="{{ url('tv/top_rated_tv_series?page=' . ($currentPage - 1)) }}">Previous</a>
                </li>
            @endif
            ...
            @for ($i = $startPage; $i <= $endPage; $i++)
                <li class="page-item @if ($i == $currentPage) active @endif">
                    <a class="page-link" href="{{ url('tv/top_rated_tv_series?page=' . $i) }}">{{ $i }}</a>
                </li>
            @endfor

            @if ($currentPage < $totalPages)
                <li class="page-item">
                    <a class="page-link" href="{{ url('tv/top_rated_tv_series?page=' . ($currentPage + 1)) }}">Next</a>
                </li>
            @endif
        </ul>
    </nav>
...
<div class="d-flex justify-content-center mt-3">
    <form action="{{ url('tv/top_rated_tv_series') }}" method="get" class="form-inline">
